...
class MainWindow:
    ...
    def _setup_window(self):
        self.root.title("Quản lý sinh viên - MySQL")
    ...
    def _build_buttons(self):
        ...
        ttk.Button(
            frame, text="Thêm", command=self.add_student
        ).pack(side="left", padx=4)

        ttk.Button(
            frame, text="Sửa", command=self.update_student
        ).pack(side="left", padx=4)

        ttk.Button(
            frame, text="Xóa", command=self.delete_student
        ).pack(side="left", padx=4)

        ttk.Button(
            frame, text="Làm mới", command=self.clear_form
        ).pack(side="left", padx=4)
    ...
    def _build_table(self):
        ...
        self.tree.column("MaSo", width=150, anchor="center")
        self.tree.column("HoTen", width=280)
        self.tree.column("DiaChi", width=350)
    ...
    def add_student(self):
        try:
            ...
            messagebox.showwarning("Thông báo", str(error))
        except Exception as error:
            messagebox.showerror(
                "Lỗi database",
                f"Không thể thêm dữ liệu.\n\n{error}"
            )
    ...
    def delete_student(self):
        ...
        try:
            self.service.delete_student(self.selected_ma_so)
